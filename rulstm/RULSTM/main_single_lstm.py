...
from models import RULSTM, RULSTMFusion, SingleLSTMForComparison
import torch
...
def get_model():
    if args.modality != 'fusion':  # single branch
        model = SingleLSTMForComparison(args.num_class, args.feat_in, args.hidden,
                       args.dropout, sequence_completion=args.sequence_completion)
        # model = RUMambaFull(args.num_class, args.feat_in, args.hidden,
        #                args.dropout, sequence_completion=args.sequence_completion)
