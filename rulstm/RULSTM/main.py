...
from models import RULSTM, RULSTMFusion, RUMambaTimeSeries, RUMambaTimeSeriesDirect, RUMamba
import torch
...
def get_model():
    if args.modality != 'fusion':  # single branch
        ...
        model = RUMamba(args.num_class, args.feat_in, args.hidden,
                       args.dropout, sequence_completion=args.sequence_completion)
        # model = RUMambaTimeSeries(args.num_class, args.feat_in, args.hidden,
        #                args.dropout, sequence_completion=args.sequence_completion)
        ...
        for mode in ['training', 'validation']:
            ...
            with torch.set_grad_enabled(mode == 'training'):
                ...
                for i, batch in enumerate(loaders[mode]):
                    ...
                    # print(f"linear_preds shape: {linear_preds.shape}")
